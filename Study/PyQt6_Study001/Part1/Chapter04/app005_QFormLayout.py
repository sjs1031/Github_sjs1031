# app005_QFormLayout.py
# import necessary modules
import sys
from PyQt6.QtWidgets import (QApplication, QWidget, QLabel, QPushButton, QLineEdit, QDateEdit, QTextEdit, QComboBox, QHBoxLayout, QFormLayout)
...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        header_label = QLabel("Apponinment From")
        ...
        # Create additonal widgets to be added in the window
        ...
        self.birtdate_edit = QDateEdit()
        self.birtdate_edit.setDisplayFormat("MM/dd/yyyy")
        self.birtdate_edit.setMaximumDate(QDate.currentDate())
        self.birtdate_edit.setCalendarPopup(True)
        self.birtdate_edit.setDate(QDate.currentDate())

        self.email_edit = QLineEdit()
        self.email_edit.setPlaceholderText("<username>@<domain>.com")
        reg_opt = QRegularExpression()
        regex = QRegularExpression("\\b[A-Z0-9._%+-]+@[A-Z0-9.-]+\\.[com]{3}\\b", reg_opt.PatternOption.CaseInsensitiveOption)
        ...
        main_form.setFormAlignment(Qt.AlignmentFlag.AlignCenter | Qt.AlignmentFlag.AlignTop)
        ...
        main_form.addRow("Date of Birth", self.birtdate_edit)
        ...
        # set the layout for the main windows
    ...
    def checkFormInformation(self):
        """Demonstrate a few cases for validating user input."""
        if self.first_name_edit.text() == "" or self.last_name_edit.text() == "":
            self.feedback_label.setText("[INFO] Misiing names.")
