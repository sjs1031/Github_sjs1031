...
class MainWindow(QMainWindow):
    ...
    def clearText(self):
        ...
        answer = QMessageBox.question(self, "Clear Text", "Do you want to clear the text?", QMessageBox.StandardButton.No | QMessageBox.StandardButton.Yes, QMessageBox.StandardButton.Yes)
    ...
    def saveToFile(self):
        """If the save button is clicked, display dialog asking user if they want to save the text in the text edit field to a text or rich text file."""
    ...
    def searchText(self):
        """Search for text."""
        # Display input dialog to ask user fot text to find 
    ...
    def chooseFontBackgroundColor(self):
        """Select a color for text's background color."""
        color = QColorDialog.getColor()
        if color.isValid():
            self.text_edit.setTextBackgroundColor(color)
    
    def aboutDialog(self):
        """Diplay the About dialog."""
        QMessageBox.about(self, "About Notepad", """<p>Beginner's Practical Guide to PyQt</p><p>Project 5.1 - Notepad</p>""")
