# app005_photo_editor.py
# import necessary modules
import sys
from PyQt6.QtWidgets import (QApplication, QMainWindow, QWidget, QLabel, QPushButton, QDockWidget, QDialog, QFileDialog, QMessageBox, QToolBar, QStatusBar, QVBoxLayout)
...
class MainWindow(QMainWindow):
    ...
    def createActions(self):
        ...
        self.open_act = QAction(QIcon("images/openfolder.png"),"Open")
        self.open_act.setShortcut("Ctrl+O")
        self.open_act.setStatusTip("Opne A new image")
        self.open_act.triggered.connect(self.openImage)

        self.save_act = QAction(QIcon("images/save.png"),"Save")
        self.save_act.setShortcut("Ctrl+S")
        self.save_act.setStatusTip("Save the current image")
        ...
        self.flip_hor_act.setStatusTip("Filp image across horizontal axis")
        self.flip_hor_act.triggered.connect(self.filpImageHorizontal)

        self.flip_ver_act = QAction("Flip Vertical")
        self.flip_ver_act.setStatusTip("Flip image across vertical axis")
        self.flip_ver_act.triggered.connect(self.filpImageVertical)
        ...
        self.clear_act = QAction(QIcon("images/Cleaner.ico"), "Clear Image")
        self.clear_act.setShortcut("Ctrl+D")
        self.clear_act.setStatusTip("Cleat the current image")
    ...
    def createToolBars(self):
        """Creat the application's toolbar."""
        tool_bar = QToolBar("Photo Edito Toolbar")
    ...
    def createToolsDockWidget(self):
        """Create the application's dock widget. Use View -> Edit image Tools menu to show/hiude the dock."""
        ...
        self.flip_hotizontal = QPushButton("Flip Horizontal")
        self.flip_hotizontal.setMinimumSize(QSize(130,40))
        self.flip_hotizontal.setStatusTip("Filp image across horizontal axis")
        self.flip_hotizontal.clicked.connect(self.filpImageHorizontal)
        ...
        self.flip_vertical.clicked.connect(self.filpImageVertical)
    ...
    def openImage(self):
        ...
        image_file, _ = QFileDialog.getOpenFileName(self, "Open Image", "", "JPG Files (*.jpg *.jpeg);; PNG Files (*.png);; Bitmap Files (*.bmp);; GIF Files (*.gif)")

        if image_file:
            self.image = QPixmap(image_file)
            self.image_label.setPixmap(self.image.scaled(self.image_label.size(), Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation))
        else:
    ...
    def saveImage(self):
        ...
        image_file, _ = QFileDialog.getSaveFileName(self, "Save Image", "", "JPG Files (*.jpg *.jpeg);; PNG Files (*.png);; Bitmap Files (*.bmp);; GIF Files (*.gif)")
    ...
    def clearImage(self):
        """Clears curretn image in the QLabel widget."""
    ...
    def rotateImage90(self):
        ...
        if self.image.isNull() == False:
            ...
            self.image_label.setPixmap(rotated.scaled(self.image_label.size(), Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation))
    ...
    def resizeImageHalf(self):
        ...
        if self.image.isNull() == False:
            ...
            self.image_label.setPixmap(resized.scaled(self.image_label.size(), Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation))
    ...
    def printImage(self):
        ...
        if print_dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            # Create QRect object to hold the printer's current viewport, which is the image_label
