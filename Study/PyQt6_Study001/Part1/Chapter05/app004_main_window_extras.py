...
class MainWindow(QMainWindow):
    ...
    def switchToFullScreen(self, state):
        """If state is True, display the main window in full screen. Otherwise, return the the window to normal."""
        if state: self.showFullScreen()
        else: self.showNormal()
    
    def createToolBar(self):
        """Create th application's toolbar."""
    ...
    def createDockWidget(self):
        ...
        # Create a QWidget that acts as a cont6ainer to hold other widgets
