...
class SelectedItems(QWidget):
    ...
    def itemsAndPrices(self):
        """
        Create the widgets so users can select an item from the combo boxes and a price from the spin boxes.
        """
        ...
        lunch_list = ["egg", "turkey sandwich", "ham sandwich", "cheese", "hummus", "yogurt", "apple", "banana", "orange", "waffle", "baby carrots", "bread", "paste", "crackers", "pretzels", "pita chips", "coffee", "soda", "water"]
        ...
        # Create two spearate price spin boxes.
    ...
    def calculateTotal(self):
        """
        Calculate and display total price from spin boxes and change value show in QLabel
        """
