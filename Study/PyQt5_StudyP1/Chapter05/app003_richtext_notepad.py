...
class Notepad(QMainWindow):
    ...
    def initializeUI(self):
        """
        Initialize the window and display its contets to the screen
        """
    ...
    def notepadMenu(self):
        ...
        new_act = QAction(QIcon('images/logo01.png'), 'New', self)
        ...
        save_act = QAction(QIcon('images/save.png'), 'Save', self)
    ...
    def saveToFile(self):
        """
        If the save button is clicked, display dialog asking user uf they want to save the text in the text edit field to a text file. 
        """
    ...
    def findTextDialog(self):
        ...
        """
        # Display input dalog to ask user for text to search for 
        find_text, ok = QInputDialog.getText(self, "Search Text", "Find:")

        extra_selections = []

        # Check to make sure the text vcan be modified
