...
class BasicMenu(QMainWindow):
    ...
    def createMenu(self):
        ...
        # Disaplay info about tools, menu, and view in the status bar
    ...
    def switchToFullScreen(self, state):
        """
        If state is True, then diaplt the main window in full screen. Otherwise, return the window to normal.
        """
        if state:
            self.showFullScreen()
        else:
